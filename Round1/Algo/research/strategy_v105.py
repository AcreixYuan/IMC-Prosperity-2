#score 2.114
#quick description: we are using the ema for the am, and we are using an equal combination of ema and mid price for the starfruit.
#hence we combine market making with an overlay of trend following
    ...
    def run(self, state: TradingState) -> tuple[dict[Symbol, list[Order]], int, str]: 
        ...
        for product in state.order_depths.keys():
            ...
            if product == 'AMETHYSTS':
                ...
                acceptable_price = (ema_price + mid_price)/2
