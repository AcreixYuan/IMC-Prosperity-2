#score 1.804 k
#quick description: for both assets we are using the ema price strategy for both assets
#analysis: ema does not do well for the starfruit, as we do not know the direction it is going
