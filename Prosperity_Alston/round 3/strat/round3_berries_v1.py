...
class Trader:
    ...
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        for product in state.order_depths.keys():
            ...
            if product != 'DOLPHIN_SIGHTINGS' and product != 'BERRIES':
                # 对不依赖时间feature的tradeable product
                ...
                if state.timestamp < 250000:
                    ...
                    # cumulative long position to 150
                    # after 9:00
                    ...
                    # cumulative short position to -150
                    # right after 12:00
