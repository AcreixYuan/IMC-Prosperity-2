    ...
    def market_status(self, state: TradingState, product) -> int:
        ...
        if product == 'PEARLS' or product == 'BANANAS':
            ...
            if len(order_depth.sell_orders) != 0 and len(order_depth.buy_orders) != 0:
                best_ask_volume = order_depth.sell_orders[min(order_depth.sell_orders.keys())]
                best_bid_volume = order_depth.buy_orders[max(order_depth.buy_orders.keys())]
                if best_ask_volume >= 100 and best_bid_volume <100:
                    return -1
                elif best_ask_volume < 100 and best_bid_volume >=100:
                    return 1
                else:
                    return 0
            ...
            if len(order_depth.sell_orders) != 0 and len(order_depth.buy_orders) != 0:
                best_ask_volume = order_depth.sell_orders[min(order_depth.sell_orders.keys())]
                best_bid_volume = order_depth.buy_orders[max(order_depth.buy_orders.keys())]
                if best_ask_volume >= 50 and best_bid_volume <50:
                    return -1
                elif best_ask_volume < 50 and best_bid_volume >=50:
                    return 1
                else:
                    return 0
        else:
    ...
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        for product in state.order_depths.keys():
            ...
            if product == 'BANANAS':
                ...
                acceptable_price = mid_price+market_status
