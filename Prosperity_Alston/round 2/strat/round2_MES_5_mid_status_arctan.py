...
class Trader:
    ...
    def __init__(self):
        ...
        self.expected_movement = {'PEARLS': 0, 'BANANAS': 0}
        ...
        for product in state.order_depths.keys():
            ...
            if product == 'PEARLS':
                ...
                if len(order_depth.sell_orders) != 0 and len(order_depth.buy_orders) != 0:
                    ...
                    # calculate factor expected movement
                    expected_movement = np.arctan((best_bid_volume +best_ask_volume)/(best_bid_volume-best_ask_volume))*4/np.pi # clip to [-1,1]
                else:
                ...
                acceptable_price = mid_price+2*self.expected_movement[product]*market_status
            ...
            if product == 'BANANAS':
                ...
                if len(order_depth.sell_orders) != 0 and len(order_depth.buy_orders) != 0:
                    ...
                    # calcualte the predicted movement
                    expected_movement = np.arctan((best_bid_volume+best_ask_volume)/(best_bid_volume-best_ask_volume))*4/np.pi # clip the value to [-1,1]
                ...
                acceptable_price = mid_price+expected_movement*market_status
