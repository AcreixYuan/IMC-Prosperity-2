...
class Trader:
    ...
    def pair_trading_1(self,state: TradingState) -> tuple[List[Order], List[Order]]:
        ...
        logger.print(f"C_pos = {C_pos}, PC_pos = {PC_pos}")
        ...
        if ETF_price < - 10:
            ...
            logger.print(f"ETF_price {ETF_price} < 1000. Buy COCONUTS {C_volume}, Sell PINA_COLADAS {PC_volume}.")
            ...
            logger.print(f"ETF_price {ETF_price} > 1000. Sell COCONUTS {C_volume}, Buy PINA_COLADAS {PC_volume}.")
