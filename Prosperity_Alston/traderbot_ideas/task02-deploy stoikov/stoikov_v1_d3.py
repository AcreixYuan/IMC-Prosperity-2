...
class Trader:
    ...
    def __init__(self):
        ...
        self.model_sig = {"PEARLS": 1.5, "BANANAS": 5.5}

    def stoikov_finite(sig, cur_pos:int, mid_price:float,timestamp:int, gamma=0.1):
        time_interval = ((199900-timestamp)/100)/2000
        return mid_price-cur_pos*gamma*pow(sig,2)*time_interval
    ...
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        for product in state.order_depths.keys():
            ...
            if product == 'PEARLS':
                ...
                print("model_sig", self.model_sig[product])
