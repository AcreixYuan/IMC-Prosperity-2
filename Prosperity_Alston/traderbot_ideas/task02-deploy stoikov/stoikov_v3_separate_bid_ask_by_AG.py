            ...
            if product == 'PEARLS':
                ...
                if len(order_depth.sell_orders) > 0:
                    ...
                    if best_ask <= reserve_bid:
                        print("HIT! BUY", str(best_ask_volume) + "x", best_ask)
                        ...
                        print("\n STATIC BUY", str(1) + "x", reserve_bid)
                ...
                if len(order_depth.buy_orders) != 0:
                    ...
                    if best_bid >= reserve_ask:
                        print("HIT! SELL", str(best_bid_volume) + "x", best_bid)
                        orders.append(Order(product, best_bid, int(np.maximum(-best_bid_volume,legal_sell_vol))))
                    else:
                        print("SUBMIT SELL", str(1) + "x", reserve_ask)
