    ...
    def run(self, state: TradingState) -> tuple[dict[Symbol, list[Order]], int, str]: 
        ...
        for product in state.order_depths.keys():
            ...
            if product == 'AMETHYSTS':
                ...
                if self.bidPrice > adjusted_conversion_ask :
                    ...
                    if quantity_to_sell> 0:
                        ...
                        logger.print(f"Selling {quantity_to_sell} ORCHIDS at price {self.bidPrice}")
                        self.positions['ORCHIDS'] -= quantity_to_sell

                        conversions = quantity_to_sell
                
                if self.askPrice < adjusted_conversion_bid:
                    # Calculate quantity to buy based on position limits
