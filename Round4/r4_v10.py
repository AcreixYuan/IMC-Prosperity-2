...
class Trader:
    ...
    def self_compute_orders_coconut(self, state: TradingState):
        ...
        if best_ask_coupon < price_coupon_fair - DEVIATION:
            orders_coupon.append(Order('COCONUT_COUPON', best_ask_coupon+1, VOLUME_COUPON))
            orders_coconut.append(Order('COCONUT', best_bid_coconut-1, -int(round(VOLUME_COUPON * delta_coconut))))
        ...
        # if the current price of COCONUT_COUPON is higher than the fair price, sell COCONUT_COUPON and buy COCONUT to hedge
            ...
            orders_coupon.append(Order('COCONUT_COUPON', best_bid_coupon-1, -VOLUME_COUPON))
            orders_coconut.append(Order('COCONUT', best_ask_coconut+1, int(round(VOLUME_COUPON * delta_coconut))))
