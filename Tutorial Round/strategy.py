...
class Trader:
    ...
    def __init__(self):
        ...
        self.last_mid_price = {'AMETHYSTS': 10000, 'STARFRUIT': 4935}
        self.mid_price = {'AMETHYSTS': {0: 10000}, 'STARFRUIT': {0: 4900}}
        self.ema_price = {'AMETHYSTS': {0: 10000}, 'STARFRUIT': {0: 4900}}
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        for product in state.order_depths.keys():
            # Check if the current product is the 'AMETHYSTS' product, only then run the order logic
            if product == 'AMETHYSTS':
                N = 20
                
                
                # Retrieve the Order Depth containing all the market BUY and SELL orders for AMETHYSTS
                ...
                # If statement checks if there are any SELL orders in the AMETHYSTS market
            ...
            if product == 'STARFRUIT':
                ...
                # Retrieve the Order Depth containing all the market BUY and SELL orders for STARFRUIT
                order_depth: OrderDepth = state.order_depths[product]
